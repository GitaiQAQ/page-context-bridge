/**
 * Sidepanel feedback UI rendering module.
 *
 * Pure lit template functions — no chrome API, no class state.
 * All interactive state is passed via RenderFeedbackTabInput callbacks.
 */
...
// sidepanel only maintains form interaction state; real business state always follows snapshot.
