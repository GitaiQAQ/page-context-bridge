...
import { createConsoleCapture, executeBuiltInTool, type ConsoleEntry } from "./content-script-core.js";
import { createRuntimeListener, sendRuntimeRequest } from "./runtime-rpc.js";
  ...
  createRuntimeListener(async (message) => {
    switch (message.method) {
      case BRIDGE_METHODS.extensionToolExecute: {
        ...
        return executeBuiltInTool(payload.tool, payload.args ?? {}, {
          win: window,
          doc: document,
          consoleEntries,
        });
