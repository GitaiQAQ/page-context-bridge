...
const tenantManager: TenantManager = new TenantManager({
  createRegistry: (tenantId: string): import("./mcp-registry.js").McpRegistry => {
    ...
    return new McpRegistry({
      ...
      debugToolCall: (toolName, args, tabId) => debugToolCallOnExtension(tenantId, tenantManager, toolName, args, tabId),
      ensureMainWorldHost: (tabId, frameId) => ensureMainWorldHostFromBridge(tenantId, tenantManager, tabId, frameId),
      ensureAgentationMain: (tabId, frameId) => ensureAgentationMainFromBridge(tenantId, tenantManager, tabId, frameId),
