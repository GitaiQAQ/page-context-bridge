...
describe("registry-utils", () => {
  ...
  describe("normalizePageToolName()", () => {
    ...
    it("removes namespace prefix when matches exactly", () => {
      ...
      const result = normalizePageToolName({ name: "catalog.catalog.click_element", _namespace: "catalog" });
      expect(result).toBe("catalog.click_element");
    });

    it("does not strip when trimmed name does not re-start with namespace", () => {
      const result = normalizePageToolName({ name: "catalog.click_element", _namespace: "catalog" });
    ...
    it("does not strip when trimmed name does not re-start with namespace", () => {
      const result = normalizePageToolName({ name: "catalog_other.click_element", _namespace: "catalog" });
