  ...
  describe("deriveFeedbackLinksFromTabState()", () => {
    ...
    it("extracts resource IDs from manifest", () => {
      ...
      state.pageContextManifestByTab.set(1, {
        ...
        route: "/home",
        namespaces: [],
        resources: [{ namespace: "ns", id: "res-1" }, { namespace: "ns", id: "res-2" }],
        skills: [],
        generatedAt: "2026-01-01T00:00:00.000Z",
      } as never);
    ...
    it("deduplicates all link values", () => {
      ...
      state.pageContextManifestByTab.set(1, {
        ...
        resources: [{ namespace: "ns", id: "res-1" }, { namespace: "ns", id: "res-1" }],
        skills: [],
        generatedAt: "2026-01-01T00:00:00.000Z",
      } as never);
      state.pageToolsByTab.set(1, [
      ...
      expect(new Set(result.links.relatedToolNames).size).toBeLessThanOrEqual(result.links.relatedToolNames.length);
    });
