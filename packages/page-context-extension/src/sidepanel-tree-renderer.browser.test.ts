          ...
          instances: [
            {
              ...
              enabledTools: 1,
              tools: [
                { kind: "builtin-tool", namespace: "builtin", instanceId: "default", toolName: "builtin.get_page_info", label: "get_page_info", enabled: true, readOnly: true, bridgeControl: false },
              ],
            },
          ],
        },
          ...
          instances: [
            {
              ...
              enabledTools: 1,
              tools: [
                { kind: "builtin-tool", namespace: "extension", instanceId: "default", toolName: "extension.get_runtime_status", label: "get_runtime_status", enabled: true, readOnly: true, bridgeControl: true },
              ],
            },
          ],
        },
          ...
          instances: [
            {
              ...
              enabledTools: 1,
              tools: [
                { kind: "builtin-tool", namespace: "feedback", instanceId: "default", toolName: "feedback.get_snapshot", label: "get_snapshot", enabled: true, readOnly: true, bridgeControl: true },
              ],
            },
          ],
        },
          ...
          instances: [
            {
              ...
              enabledTools: 1,
              tools: [
                { kind: "builtin-tool", namespace: "builtin", instanceId: "default", toolName: "builtin.navigate", label: "navigate", enabled: true, readOnly: false, bridgeControl: false },
              ],
            },
          ],
        },
          ...
          instances: [
            {
              ...
              enabledTools: 1,
              tools: [
                { kind: "builtin-tool", namespace: "extension", instanceId: "default", toolName: "extension.reconnect", label: "reconnect", enabled: true, readOnly: false, bridgeControl: true },
              ],
            },
          ],
        },
