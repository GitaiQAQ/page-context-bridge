  ...
  test: {
    coverage: {
      ...
      include: [
        ...
        'packages/page-context-feedback/src/**/*.ts',
        'packages/page-context-agentation/src/**/*.ts',
      ],
      exclude: ['**/*.test.ts', '**/*.browser.test.ts', '**/*.d.ts', '**/dist/**', '**/vendor/**'],
      thresholds: {
        statements: 30,
        branches: 25,
        functions: 30,
    ...
    projects: [
      ...
      },
      {
        test: {
          name: 'feedback',
          include: ['packages/page-context-feedback/src/**/*.test.ts'],
          environment: 'node',
        },
      },
      {
        test: {
          name: 'agentation',
          include: ['packages/page-context-agentation/src/**/*.test.ts'],
          environment: 'node',
        },
      },
    ],
